  ...
  <div className="bg-white mt-24 border-t border-gray-100 ">
    <div className=" dark:bg-gray-800 pt-6">
      <div className="container m-auto space-y-8 px-6 text-gray-600 dark:text-gray-300 md:px-12 lg:px-20">
        <div>
          <div className="mb-3 items-center justify-between gap-6 py-6 sm:flex md:mb-16 md:space-y-6 md:py-0">
            <Link to="/" className="flex justify-center items-center ml-8  text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
          ...
          <div>
            <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
              <div>
                ...
                <ul className="mt-4 list-inside space-y-4">
                  ...
                  <li>
                    <a href="#" className="transition hover:text-primary">Internships</a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="mt-4 list-inside space-y-4">
                  <li>
                    <a href="#" className="transition hover:text-primary">A2SV</a>
                  </li>
                  <li>
                    <a href="#" className="transition hover:text-primary">SKALATE</a>
                  </li>
                  <li>
                    <a href="#" className="transition hover:text-primary">iCog-Lab</a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="mt-4 list-inside space-y-4">
                  ...
                  <li>
                    <a href="#" className="transition hover:text-primary">Community</a>
                  </li>
                  <li>
                    <a href="#" className="transition hover:text-primary">Internships</a>
                  </li>
            ...
            <div className="flex justify-between border-t border-cyan-800 py-8 text-gray-200">
              <span>&copy; CareerNet Africa 20023 Hackathon <span id="year"></span></span>
